...
par(mar = c(5,5,4,0)+.1, cex.lab = 1.25, cex.main = 2)
if(mode == 'dark'){
    par(fg = 'white', bg = '#222222', col.axis = 'white', col.lab = 'white', col.main = 'white', col.sub = 'white')
}
...
for(i in 1:length(curves)){
    ...
    lines(curves[[i]]$Date, curves[[i]]$margin, col=cc[2], lwd=4.5)
...
par(mar = c(5,0,4,1)+.1)
plot.new()
legend('left', legend = rep('', nrow(lgnd)), bty='n', lwd=4.5, col = lgnd$color2, cex = 1.3)
legend('left', legend = lgnd$nameRecord, 
       bty='n', lwd=3, col = lgnd$color1, cex = 1.3)
}
